...
$this->create('encryption', 'apps/files/a_encryption/encryption.php')
	->actionInclude('files/a_encryption/encryption.php');
$this->create('decryption', '/apps/files/a_encryption/decryption.php')
	->actionInclude('files/a_encryption/decryption.php');

$this->create('sign', 'apps/files/a_digital_signature/sign.php')
	->actionInclude('files/a_digital_signature/sign.php');
$this->create('vertify', '/apps/files/a_digital_signature/vertify.php')
	->actionInclude('files/a_digital_signature/vertify.php');
$this->create('test', 'apps/files/a_digital_signature/test.php')
	->actionInclude('files/a_digital_signature/test.php');
// $this->create('ok', 'apps/files/lib/Controller/PwdController.php')
// 	->actionInclude('files/lib/Controller/PwdController.php');
...
$application->registerRoutes(
	...
	[
		...
		'ocs' => [
			// ['name' => 'Pwd#createPwd', 'url' => '/create_pwd', 'verb' => 'POST'],
			// ['name' => 'Pwd#getPwd', 'url' => '/get_pwd', 'verb' => 'GET'],
			[
